...
{
    public partial class frmExpensesReport : MaterialSkin.Controls.MaterialForm
    {
        DB con = new DB();
        ...
        private void btnPrint_Click_1(object sender, EventArgs e)
        {
            ...
            dtLines = con.GetData("select * from  ExpensesView where Date between '" + dtFrom.EditValue + "' and '" + ToDate + "'");


            Report rpt = new Report();
            rpt.Load(@"ReportsForms\ExpensesReport.frx");
